    ...
    $tour_details_html = '<div class="important">
        <div class="text">
            ...
            <div style="display: flex; align-items: center; gap: 100px;">
                <span style="background-color:red; color:white; border-radius: 50%;text-align: center;padding: 20px 10px;">
                    <span style="font-size: 0.7rem;">Day</span><br><span style="font-size: 1.2rem;">1</span>
                </span>
