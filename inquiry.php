    ...
    $tour_details_html = '<div class="important">
        <div class="text">
            ...
            <div style="display: flex; align-items: center; gap: 100px;">
                <span style="background-color:red; color:white; border-radius: 50%;text-align: center;padding: 20px 5px;">
                    <span style="font-size: 0.5rem;">Day</span><span style="font-size: 1.2rem;">1</span>
                </span>
